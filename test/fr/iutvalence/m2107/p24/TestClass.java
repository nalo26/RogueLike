...
public class TestClass extends TestCase {
	...
	public void testRoom() {
		...
		assertEquals("The right door of room 1 exists.", room1.isOpen(Direction.RIGHT), true);
		assertEquals("The left door of room 2 exists.", room2.isOpen(Direction.LEFT), true);
